...
var EmployeeCountComponent = /** @class */ (function () {
    function EmployeeCountComponent() {
        this.selectedRBvalue = 'All';
        this.countRBselectionChanged = new core_1.EventEmitter();
    }
    EmployeeCountComponent.prototype.onRBselectionChanged = function () {
        this.countRBselectionChanged.emit(this.selectedRBvalue);
        console.log(this.selectedRBvalue);
    };
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], EmployeeCountComponent.prototype, "countRBselectionChanged", void 0);
    __decorate([
        core_1.Input(),
